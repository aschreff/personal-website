...
export const ArsAmatoriaBookThreeLines = [
  ...
  'As the delightful error of the name became known to the poor girl,',
  'Both her mind and then the color in her face returned.',
  'She rises, and the wife, about to rush to the embrace of her husband,',
  'Moves the adjacent bushes with her agitated body.',
  'He, having thought he had seen a beast, grabbed his bow,',
  'Youthfully, his arrows were in his right hand--',
  'What are you doing, unlucky one? It is not a beast, stop your arrows--',
  'Ah misery! Your girl is pierced by your dart.',
  '"Ah me!" she shouts, "You have pierced my gentle heart,',
  'This place often bears wounds from Cephalus.',
  'I die before day, but wounded by no mistress,',
  'Earth, this will make you light for me, after being buried.',
  'Now my spirit goes out into the winds, mis-trusted by your name,',
  'Ah, I perish, close my dear eyes with your hand."',
  'He holds the dying body of his wife in his mournful bosom,',
  'And washes her cruel wounds with his tears.',
  'She left, and her breath, slipped away bit by bit from her unsuspecting chest,',
  'Is rescued by the mouth of her miserable husband.',
  'But let us return to our work, I must go with bare essentials,',
  'So that my ship may reach your ports.',
  'You await anxiously, while I lead you into dinner parties,',
  'And you too seek my advice in this part.',
  'Come late and approach gracefully, after the midnight oil has been placed,',
  'You will arrive with a grateful delay, a delay is the best seductress.',
  'And if you be ugly, you can be seen as beautiful,',
  'And the night itself will give retreats for your defects.',
  'Take the food with your fingers (it is a certain gesture of eating),',
  "And don't besmear your face with a dirty hand.",
  'And do not consume beforehand at home, but stop before what you want,',
  'Be a little less than what you can be.',
  'If Paris would see Helen eating greedily,',
  'He would have hated her, and said, "My prize is foolish."',
  'It is more suitable and may be fitting for girls to drink more,',
  "Because you don't do badly with the boy of Venus, Bacchus.",
  'This too, with what your head is tolerant,',
  'And your mind and feet withstand, and you not see two of which there is one.',
  'A woman, intoxicated by much wine, laying down shamefully,',
  'She is deserving to endure whatever sexual acts.',
  'And is not safe to succumb to sleep with the table set,',
  'Many shameful things are accustomed to happen through sleep.',
  'It is shameful to have taught more, but nourishing Venus,',
  'Says, "Our work is chiefly that which is shameful."',
  'Let each girl be known to herself, take up certain matters,',
  'From your body, one style does not suit everyone.',
  'She who will be outstanding in her face, bend while laying down,',
  'Let them see you from behind, you whose back pleases.',
  'Milanion used to bear Atalantan legs in his arms,',
  'If there are goods, these must be presently seen.',
  'Let a small thing be carried by a horse, because she was very tall,',
  "His Theban bride never sat on Hector's horse.",
  'Let a woman, known by her long side, press the bed with her knees,',
  'With her neck having been bent back a little.',
  'To she whose thigh is youthful, and whose breasts lack blemishes,',
  'Let a man stand, let her be spread out on a slanted bed.',
  "And don't think it shameful to untie your hair,",
  'As a Phylleian mother, and bend your neck back with loosened hair.',
  'You too, whom Lucina marked your belly with creases,',
  'Use your horses, turned away, like the swift Parthan.',
  'A thousand jests of Venus, the simple and smallest of works,',
  'When she lays, half-turned, on her right side.',
  'But neither the oracles of Apollo nor the horned Ammon,',
  'May sing more truth to you all than my muse.',
  'If you trust such things, believe in the skills which we have made,',
  'With long use, our songs will stand before faith.',
  'Let a released woman feel love from her innermost parts,',
  'And let her help both sides from an equal place.',
  'And do not let alluring voices and joyful murmurs cease,',
  'Nor let wicked words pass over in the middle of games.',
  'You too, whom nature has denied the touch of love,',
  'Form sweet joys with a deceitful sound.',
  'Unlucky girl, to whom that tasteless place is numb,',
  'With which man and woman ought to be enjoyed equally.',
  'Only beware, when you fake it, that you not be caught,',
  'Bring about belief through your motion and eyes themselves.',
  'Let her show it through both shouts and shortness of breath,',
  'Which may help, ah it is a shame, that part holds secret signs.',
  'She who will ask for a loving gift after the joys of love,',
  'That one will not want your burden to bear her requests.',
  'And do not let light inot the bedchamber with every window,',
  'It is fitting for much of your body to lay hidden.',
  'The game has its end, it is time to descend from the swans,',
  'Who have taken my yokes under their necks.',
  'So that youthful girls, now thusly, my crowd,',
  'My inscribe on their spoils, "Ovid was my teacher."',
];
...
export const Catullus1Lines = [
  ...
  'Something of my trifles,',
  'Already then, when you, alone of the Italians,',
  'Had dared to unfold all of time,',
  'In three learned and laborious books, by Jove.',
  'Therefore, have whatever of this little book for yourself,',
  'And whatever it is worth, o virgin protector,',
...
export const Catullus2Lines = [
  ...
  'And will arouse bites of bitterness,',
  'When I do not know what precious thing is pleasing,',
  'To be played with by my shining desire.',
  'I think that, when a serious passion subsides,',
  'Let there be small consolation of her grief,',
...
export const Catullus3Lines = [
  ...
  'For he was as sweet as honey,',
  'And had known her so well as a girl to her mother.',
  'Nor would he move from her bosom,',
  'But leaping about, now here, now there,',
  'Would whimper up to his mistress alone.',
  'Who now goes on a dark journey to that place,',
  'From whence, they forbid anyone to return.',
  'But let there be malice to you all, nasty shadows of Orcus,',
  'Who devour all beautiful things.',
  'So you have snatched away a beautiful sparrow from me,',
  'O awful thing! O poor sparrow!',
  'Now by your work, the poor little eyes of my girl,',
...
export const Catullus4Lines = [
  ...
  'Whether the work would fly,',
  'By palms or by linen.',
  'And the shore of the menacing Adriatic,',
  'Does not deny this, nor the Cycladian isle,',
  'And noble Rhodes and the rough Thracian Propontis,',
  'Nor the grim gulf of Pontus,',
  'Where after there was a ship, before was covered in woods,',
  'For on the yoke of Cytorus,',
  'The talking leaves often bore a whistling.',
  'Pontic Amastris and Cytorus bearing box-trees,',
  'My ship said that she had been and is,',
  'Very well-known to you,',
  'She says that she is the last from your birthplace,',
  'To have stood on your peak,',
  'To have dipped her palms in your water,',
  'And from that place, to have brought her owner,',
  'Through so many powerless seas,',
  'Whether left or right breeze would be called upon,',
  'Or Jove would come down next, on foot, on all sides, all at once.',
  'So that now vow would be made to herself,',
  'By the gods of the seashore, when she was coming,',
  'From the nearest sea all the way to this clear pond.',
  'But these things happened before,',
  'Now she grows old, concealed at rest, and dedicates herself to you,',
...
export const Catullus5Lines = [
  ...
  'When our brief light dies,',
  'We must sleep one everlasting night.',
  'Give me a thousand kisses, then a hundred,',
  'Then another thousand, then a second hundred,',
  'Then all the way, another thousand, another hundred.',
  'Then, when we have made many thousands,',
  'We will mix them up, so no one will know,',
...
export const Catullus14Lines = [
  ...
  'Why would you destroy me so badly with all these poets?',
...
export const Catullus15Lines = [
  ...
  'Having molested good boys and bad.',
