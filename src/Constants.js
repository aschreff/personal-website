...
export const ArsAmatoriaBookThreeLines = [
  ...
  'Many hold the crime of a deceieved lover.',
  ...
  'No trust is left with Phyllis, having been decieved.',
  ...
  'Let your loiiver always be mentioned as a female while writing,',
  'Let it be "she" in your notes, not "he."',
  'If it is allowed to ber my heart from small things to those greater,',
