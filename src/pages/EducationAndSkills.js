      ...
      descriptions: [
        {
          type: 'paragraph',
          content:
            'I attended Carnegie Mellon University and graduated with a BS in Chemical Engineering, with a GPA of 3.47. I was a member of the Sigma Nu Fraternity, holding multiple positions including President and Treasurer.',
        },
      ],
      image: '/imgs/cmu.png',
    },
      ...
      descriptions: [
        {
          ...
          content: [
            ...
            <StyledTag color={'blue'}>PostgreSQL</StyledTag>,
            <StyledTag color={'blue'}>MongoDB</StyledTag>,
            <StyledTag color={'blue'}>Docker</StyledTag>,
            <StyledTag color={'blue'}>Redis</StyledTag>,
            ...
            <StyledTag color={'purple'}>Google Cloud Platform</StyledTag>,
            <StyledTag color={'purple'}>BigQuery</StyledTag>,
