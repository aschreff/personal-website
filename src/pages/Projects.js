  ...
  const projects = [
    ...
    },
    {
      ...
      descriptions: [
        {
          type: 'paragraph',
          content: 'This is a virtual stage and script builder application, coded in Python. I utilized Pygame for this project, but other than that, everything is completely original.'
        }
      ],
    ...
    },
    {
      ...
      descriptions: [
        {
          type: 'paragraph',
          content: 'I led a team of three engineering students to create a thermo-protective glove that alerts the user of their frostbite risk level utilizing Arduino and thermistor technology. We presented to a panel of professional engineers after finishing the project.'
        }
      ],
    ...
    },
    {
      ...
      descriptions: [
        {
          type: 'paragraph',
          content: 'This is a music sounds system that has hands-free music controls. Sonar readers will read your hand positions and can raise or lower volume, skip tracks, pause tracks, and play tracks based on your hand position. The core of this project is Arduino technology.'
        }
      ],
